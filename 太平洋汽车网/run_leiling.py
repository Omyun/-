...
lx = "雷凌"
url = 'https://www.dongchedi.com/motor/car_page/v3/get_picture/?version_code=445&category=wg&series_id=534&offset=0&car_id=null'
...
while offset+30<total_count:
    url = 'https://www.dongchedi.com/motor/car_page/v3/get_picture/?version_code=445&category=wg&series_id=534&offset='+str(offset)+'&car_id=null'
    offset += 30
    data = lib.web.GETx(url=url,head="",pro=0)
    jsond = json.loads(data)
